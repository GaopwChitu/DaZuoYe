<template>
    <div>
        ...
        <el-card>
            <el-row :gutter="20">
                ...
                <el-col :span="6">
                    <div>
                        ...
                        <el-select placeholder="请选择社区" v-model="queryInfo.communityCd" clearable filterable
                            @click="getCommunityList" style="width: 70%; padding-right: 10px">
                ...
                <el-col :span="6">
                    ...
                    <el-button type="primary" icon="el-icon-plus" @click="isInsert = true">添加社区</el-button>
                </el-col>
            </el-row>
            ...
            <el-table :data="communityList" border stripe :default-sort="{ prop: 'updateTime', order: 'ascending' }">
                <el-table-column type="expand">
                    <template v-slot="scope">
                        <el-form label-position="center" inline class="demo-table-expand">
                            ...
                            <el-form-item label="社区面积："><span>{{ scope.row.communityArea + ' m²'
                            }}</span></el-form-item>
                            ...
                            <el-form-item label="老年人数：">
                                ...
                                <el-button style="margin-left: 320px" type="primary" icon="el-icon-edit" size="mini"
                ...
                <el-table-column label="更新时间" prop="updateTime" align="center" min-width="100px"
        ...
        <!--    修改-->
        <el-dialog title="修改社区信息" :visible.sync="isShowEdit" width="50%" @close="editClosed">
...
export default {
    ...
    methods: {
        ...
        async deleteCommunity(id) {
            ...
            const { data: res } = await this.$http.post("/community/deleteById?id=" + id)
            if (res !== "success") {
        ...
        addCommunity() {
            this.$refs.insertFormRef.validate(async valid => {
                if (!valid) return;
                this.addForm.id = (JSON.parse(window.sessionStorage.getItem("user"))).id;
        ...
        async StateChange(communityInfo) {
            const { data: res } = await this.$http.post(`/community/updateState?id=${communityInfo.id}&state=${communityInfo.state}`);
            if (res != "success") {
