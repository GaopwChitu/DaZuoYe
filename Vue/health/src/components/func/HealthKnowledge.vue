  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="knowledgeList" border stripe :default-sort="{ prop: 'updateTime', order: 'ascending' }">
        <el-table-column label="索引" prop="id" align="center"></el-table-column>
      ...
      <el-dialog title="添加文章" :visible.sync="insert" width="70%" @close="insertClosed">
        <el-form :model="addKnowledgeForm" :rules="addKnowledgeFormRules" ref="addKnowledgeFormRef" label-width="100px">
          ...
          <el-form-item label="正文:" prop="content">
            <qu-editor v-model="addKnowledgeForm.content"></qu-editor>
          </el-form-item>
        </el-form>
      ...
      <div class="dialog_diy">
        <el-dialog :visible.sync="isReading" width="70%" style="padding: 0">
          <div slot="title" class="header-title"
            style="background-color: #4A5064;color: white;text-align: center;padding-top: 0">
      ...
      <el-dialog title="修改文章信息" :visible.sync="editDialogVisible" width="60%" @close="editClosed">
        <el-form :model="editKnowledgeForm" :rules="addKnowledgeFormRules" ref="editKnowledgeFormRef"
          label-width="160px">
          <el-form-item label="文章名称:" prop="bookName">
          ...
          <el-form-item label="正文:" prop="content">
            <qu-editor v-model="editKnowledgeForm.content"></qu-editor>
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
...
<script>
import QuEditor from "../../utils/quEditor.vue";
export default {
  ...
  methods: {
    ...
    editClosed() {
      this.$refs.editKnowledgeFormRef.resetFields();
    },
    ...
    submitCancle() {
      this.$refs.editKnowledgeFormRef.validate(async valid => {
        if (!valid) return;
        this.editKnowledgeForm.updateId = this.id;
